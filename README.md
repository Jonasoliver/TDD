...
Os arquivos originais estão em `docs/evidencias/`.

### Exercício 1 — Python + pytest (`28 passed`)
![Ex1 — pytest início](docs/evidencias/ex1-pytest-1.png)
![Ex1 — pytest final / 28 passed](docs/evidencias/ex1-pytest-2.png)

### Exercício 2 — Java + Maven + JUnit 5 (`Tests run: 40, BUILD SUCCESS`)
![Ex2 — mvn clean test início](docs/evidencias/ex2-mvn-1.png)
![Ex2 — mvn clean test resultado](docs/evidencias/ex2-mvn-2.png)

### Exercício 3 — TypeScript + Jest (`21 passed`)
![Ex3 — npx jest início](docs/evidencias/ex3-jest-1.png)
![Ex3 — npx jest final / 21 passed](docs/evidencias/ex3-jest-2.png)
